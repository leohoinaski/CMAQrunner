...
def writePrepMeganInput(MEGANHome,wrf_file,ncols,nrows):  
    ...
    file1 = open(scriptPath + "/prepmegan4cmaq.inp","w", newline='\n') 
    file1.write('&control\n')
   # file1.write('\n')
    file1.write('start_lai_mnth = 1,\n')
    file1.write('end_lai_mnth   = 12,\n')              
    file1.write("wrffile = '"+wrf_file+"',\n")
    file1.write("megan_dir = '"+MEGANHome+"/input',\n")
    file1.write("out_dir = '"+MEGANHome+"/input',\n")
   # file1.write('\n')
    file1.write('/\n')
   # file1.write('\n')
    file1.write('&windowdefs\n')
   # file1.write('\n')
    file1.write(' x0         =  1,\n')
    file1.write(' y0         =  1,\n')
    file1.write(' ncolsin    =  '+str(ncols)+',\n')    
    file1.write(' nrowsin    =  '+str(nrows)+',\n')    
   # file1.write('\n')
    file1.write('/\n') 
    file1.close()
    return MEGANHome    
...
def writePrepMeganCantype(MEGANHome,wrf_file,ncols,nrows):  
    scriptPath = MEGANHome +'/MEGAN31_Prep_Code_July2020'       
    file1 = open(scriptPath + "/prepmegan4cmaq_cantype.inp","w", newline='\n') 
    file1.write('&control\n')
    #file1.write('\n')
    file1.write('start_lai_mnth = 1,\n')
    file1.write('end_lai_mnth   = 12,\n') 
    ...
    #file1.write('\n')
    file1.write('&cantype\n')
    file1.write("treefilename  = 'GF3aTree.nc3\n")
    file1.write("treevarname   = 'm20tree'\n")
    file1.write("treefillvalue = '-128'\n")
    file1.write("NTfilename  = 'NTfrac_reorder_lat.nc'\n")
    file1.write("NTvarname   = 'NTfrac'\n")
    file1.write("NTfillvalue = '0.'\n")
    file1.write("TRTfilename  = 'tropfrac_reorder_lat.nc'\n")
    file1.write("TRTvarname   = 'tropfrac'\n")
    file1.write("TRTfillvalue = '-1'\n")
    file1.write("shrubfilename = 'GF3aShrub.nc3'\n")
    file1.write("shrubvarname  = 'm204shrub'\n")
    file1.write("shrubfillvalue = '-128'\n")
    file1.write("grassfilename = 'GF3aGrass.nc3'\n")
    file1.write("grassvarname  = 'm202grass'\n")
    file1.write("grassfillvalue = '-128'\n")
    file1.write("cropfilename  = 'GF3aCrop.nc3'\n")
    file1.write("cropvarname   = 'm20crop'\n")
    file1.write("cropfillvalue = '-128'\n")
    file1.write('/\n')
    #file1.write('\n')
    file1.write('&windowdefs\n')
    #file1.write('\n')
...
def writePrepMeganGrwform(MEGANHome,wrf_file,ncols,nrows):  
    scriptPath = MEGANHome +'/MEGAN31_Prep_Code_July2020'       
    file1 = open(scriptPath + "/prepmegan4cmaq_grwform.inp","w", newline='\n') 
    file1.write('&control\n')
    #file1.write('\n')
    file1.write('start_lai_mnth = 1,\n')
    file1.write('end_lai_mnth   = 12,\n')              
    ...
    file1.write('/\n')
    #file1.write('\n')
    file1.write('&growthform\n')
    file1.write("treefilename  = 'tree30s_reorder_lat.nc'\n")
    file1.write("treevarname   = 'treeFrac'\n")
    file1.write("treefillvalue = '-1'\n")
    file1.write("shrubfilename = 'shrb30s_reorder_lat.nc'\n")
    file1.write("shrubvarname  = 'shrubFrac'\n")
    file1.write("shrubfillvalue = '-1'\n")
    file1.write("grassfilename = 'gras30s_reorder_lat.nc'\n")
    file1.write("grassvarname  = 'grassFrac'\n")
    file1.write("grassfillvalue = '-1'\n")
    file1.write("cropfilename  = 'crop30s_reorder_lat.nc'\n")
    file1.write("cropvarname   = 'cropFrac'\n")
    file1.write("cropfillvalue = '-1'\n")
    #file1.write('\n')
    file1.write('/\n')
    #file1.write('\n')
    file1.write('&windowdefs\n')
...
def writePrepMeganEcotype(MEGANHome,wrf_file,ncols,nrows):  
    scriptPath = MEGANHome +'/MEGAN31_Prep_Code_July2020'       
    file1 = open(scriptPath + "/prepmegan4cmaq_ecotype.inp","w", newline='\n') 
    file1.write('&control\n')
    #file1.write('\n')
    file1.write(' start_lai_mnth = 1,\n')
    file1.write(' end_lai_mnth   = 12,\n')              
    ...
    file1.write(" megan_dir = '"+MEGANHome+"/input',\n")
    file1.write(" out_dir = '"+MEGANHome+"/input',\n")
    file1.write(" inpname = 'ecotype30s_reorder_lat.nc',\n")
    file1.write(" varname = 'ecotype',\n")
    file1.write(" fillvalue = '32767',\n")
    #file1.write('\n')
    file1.write('/\n')
    #file1.write('\n')
    file1.write('&windowdefs\n')
...
def writeRunMet2mgn(MEGANHome,GDNAM,YEAR,STJD,EDJD,mcipPath):  
    ...
    file1.write('\nsource ../setcase.csh')
    file1.write('\nforeach dom ( '+GDNAM+' )')
    file1.write('\nsetenv sJDATE '+str(YEAR)+str(STJD))
    file1.write('\nsetenv eJDATE '+str(YEAR)+str(EDJD))
    ...
    file1.write('\nsetenv GRIDDESC '+MEGANHome+'/MEGANv3.21/work/GRIDDESC')
    file1.write('\nsetenv GDNAM3D ${dom}')
...
def writeRunDaymet(MEGANHome,mcipPath,GDNAM,YEAR,STJD):  
    ...
    file1.write('\nsetenv STARTDATE '+str(YEAR)+str(STJD))
    file1.write('\nsetenv ENDDATE ' +str(YEAR)+str(STJD))
    file1.write('\nsetenv RUNDAY 1')
...
def writeRunMegcan(MEGANHome,mcipPath,GDNAM,YEAR,STJD):
    ...
    file1.write('\n#set JD = 2019059')
    file1.write('\n#set ED = 2019120')
    file1.write('\nset JD = '+str(YEAR)+str(STJD))
    file1.write('\nset ED = '+str(YEAR)+str(STJD))
    file1.write('\nset JDi = '+str(YEAR)+str(STJD))
    file1.write('\nwhile ($JD <= $ED)')
    file1.write('\n########################################################################')
...
def writeRunMegsea(MEGANHome,mcipPath,GDNAM,YEAR,STJD):
    ...
    #file1.write('\nsetenv GRIDDESC '+mcipPath+'/GRIDDESC')
    file1.write('\nsetenv GRIDDESC '+MEGANHome+'/MEGANv3.21/work/GRIDDESC')
    file1.write('\nsetenv SDATE '+str(YEAR)+str(STJD))
    file1.write('\nsetenv EDATE '+str(YEAR)+str(STJD))
    file1.write('\n')
    file1.write('\n')
    file1.write('\nset JD = $SDATE')
    file1.write('\nwhile ($JD <= $EDATE )')
...
def writeRunMegvea(MEGANHome,mcipPath,GDNAM,YEAR,STJD):
...
def writeRunMgn2mech(MEGANHome,mcipPath,GDNAM,YEAR,STJD):
    file1 = open(MEGANHome+"/MEGANv3.21/work/run.mgn2mech.v32.csh","w") 
    file1.write('#! /bin/csh -f')
    file1.write('\n########################################################################')
    file1.write('\nsource ../setcase.csh')
    file1.write('\n## Directory setups')
...
def writeRunMEGANsetcase(MEGANHome):
    file1 = open(MEGANHome+"/MEGANv3.21/setcase.csh","w", newline='\n') 
    file1.write('#! /bin/csh\n')
    #file1.write('\nsetenv HM "'+MEGANHome+'"')
    file1.write('setenv MGNHOME "'+MEGANHome+'/MEGANv3.21"\n')
    file1.write('setenv MGNSRC $MGNHOME/src\n')
    file1.write('setenv MGNRUN $MGNHOME/work\n')
    file1.write('setenv MGNEXE $MGNHOME/bin\n')
    file1.write('setenv MGNINP $MGNHOME/Input\n')
    file1.write('setenv MGNOUT $MGNHOME/Output\n')
    file1.write('setenv MGNINT $MGNHOME/Output/INT\n')
    file1.write('setenv MGNLOG $MGNHOME/work/logdir\n')
    #file1.write('\n\n')
    #file1.write('\n')
    file1.write('if ( ! -e $MGNSRC ) mkdir -p $MGNSRC\n')
    file1.write('if ( ! -e $MGNRUN ) mkdir -p $MGNRUN\n')
    file1.write('if ( ! -e $MGNINP ) mkdir -p $MGNINP\n')
    file1.write('if ( ! -e $MGNOUT ) mkdir -p $MGNOUT\n')
    file1.write('if ( ! -e $MGNINT ) mkdir -p $MGNINT\n')
    file1.write('if ( ! -e $MGNLOG ) mkdir -p $MGNLOG\n')
    #file1.write('\n')
    #file1.write('')
    file1.write('if ( ! -e $MGNEXE ) then\n')
    file1.write('   mkdir -p $MGNEXE\n')
    file1.write('endif\n')
    file1.write('if ( ! -e $MGNINP ) then\n')
    file1.write('   mkdir -p $MGNINP/MAP\n')
    file1.write('   mkdir -p $MGNINP/MGNMET\n')
    file1.write('endif\n')
    file1.close()
    return MEGANHome                
...
if __name__ == '__main__':
    ...
    writeRunDaymet(MEGANHome,mcipPath,GDNAM,YEAR,STJD)
    writeRunMegcan(MEGANHome,mcipPath,GDNAM,YEAR,STJD)
    writeRunMegsea(MEGANHome,mcipPath,GDNAM,YEAR,STJD)
    writeRunMegvea(MEGANHome,mcipPath,GDNAM,YEAR,STJD)
    writeRunMgn2mech(MEGANHome,mcipPath,GDNAM,YEAR,STJD)
